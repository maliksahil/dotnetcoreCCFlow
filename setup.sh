...
az ad app create --display-name newappname --reply-urls "https://localhost:44377/" --oauth2-allow-implicit-flow true --password e791fcb9-6234-4327-bd01-bd43754ca15f
